...
class OverBoard extends StatefulWidget {
  ...
  static OverBoardState of(BuildContext context) =>
      context.findRootAncestorStateOfType<OverBoardState>();
...
class OverBoardState extends State<OverBoard> with TickerProviderStateMixin {
  ...
  _getStack() {
    print("_animator.getAnimator().value=" +
        _animator.getAnimator().value.toString());
                        ...
                        builder: (context, child) {
                          _counterForDots =
                              (_swipeDirection == SwipeDirection.RIGHT_TO_LEFT)
                                  ...
                                  : _counter.toDouble() +
                                      1 -
                                      _animator.getAnimator().value;
                          if (_counterForDots < 0) _counterForDots = 0;
                          ...
                          return Container(
                            ...
                            child: DotsIndicator(
                              ...
                              position: _counterForDots,
                              decorator: const DotsDecorator(
                                size: Size(10.0, 10.0),
                                color: Color(0xFFE0E0E0),
                                activeSize: Size(16.0, 16.0),
                                activeColor: ThemeManager.colorMain,
          ...
          : Column(
              ...
              children: <Widget>[
                page.doAnimateImage
                    ...
                    : Image.asset(page.imageAssetPath, fit: BoxFit.fitWidth),
                Positioned(
